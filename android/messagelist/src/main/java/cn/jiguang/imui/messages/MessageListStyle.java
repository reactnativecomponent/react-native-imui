...
public class MessageListStyle extends Style {
    ...
    public Drawable getLinkDrawable() {
        if (receiveBubbleDrawable == -1) {
            return getMessageSelector(Color.WHITE, mContext.getResources().getColor(R.color.link_pressed),
                    mContext.getResources().getColor(R.color.link_pressed),R.drawable.link_bg);
        } else {
            return ContextCompat.getDrawable(mContext, R.drawable.link_bg);
        }
    }
    public Drawable getRedPacketTopDrawable() {
        if (receiveBubbleDrawable == -1) {
            return getMessageSelector(mContext.getResources().getColor(R.color.red_packet_bg), mContext.getResources().getColor(R.color.red_packet_bg_pressed),
                    mContext.getResources().getColor(R.color.red_packet_bg_pressed),R.drawable.red_packet_top);
        } else {
            return ContextCompat.getDrawable(mContext, R.drawable.red_packet_top);
        }
    }
}
