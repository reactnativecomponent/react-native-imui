...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ClickTouchLinkNotification" object:@"begin" userInfo:nil];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ClickTouchLinkNotification" object:@"end" userInfo:nil];
