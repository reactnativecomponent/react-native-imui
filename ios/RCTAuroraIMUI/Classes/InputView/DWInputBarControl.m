...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = toolBackColor;
...
- (void)setDefaultToolHeight:(CGFloat)defaultToolHeight{
    if (defaultToolHeight) {
        ...
        _defaultToolHeight = DESIGN_SIZE_750(70);
    }
...
//    _inputGrowView.placeholder = @"点击输入文字";
    ...
    [_showMenuBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/more_ios"] forState:UIControlStateNormal];
    [_showMenuBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/more_ios_HL"] forState:UIControlStateHighlighted];
    [_showExpressionBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/face"] forState:UIControlStateNormal];
    [_showExpressionBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/face_HL"] forState:UIControlStateHighlighted];
    [_showExpressionBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/keyboard"] forState:UIControlStateSelected];
    [_showRecordeBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/voice"] forState:UIControlStateNormal];
    [_showRecordeBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/voice_HL"] forState:UIControlStateHighlighted];
    [_showRecordeBtn setBackgroundImage:[UIImage nim_fetchView:@"/viewImgs/keyboard"] forState:UIControlStateSelected];
...
- (void)creatUI{
    ...
    _toolView.frame = CGRectMake(0, 0, screenW, self.toolH);
