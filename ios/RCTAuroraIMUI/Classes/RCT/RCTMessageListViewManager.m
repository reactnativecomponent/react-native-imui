...
//    NSURL *url = [[NSBundle mainBundle] URLForResource:@"AuroraIMUI" withExtension:@"bundle"];
    NSString *strPath = [[NSBundle mainBundle]pathForResource:@"AuroraIMUI" ofType:@"bundle"];
