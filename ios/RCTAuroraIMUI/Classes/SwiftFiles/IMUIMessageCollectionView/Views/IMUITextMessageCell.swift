...
public static let screenW = UIScreen.main.bounds.size.width
  ...
  func layoutToText(with text: String, isOutGoing: Bool) {
    ...
    if isOutGoing {
        self.textMessageLable.setupDWText(text, andUnunderlineColor: UIColor.init(red: 187/255.0, green: 220/255.0, blue: 255/255.0, alpha: 1))
        textMessageLable.textColor = UIColor.white
        
    } else {
        self.textMessageLable.setupDWText(text, andUnunderlineColor: UIColor.init(red: 51/255, green: 51/255, blue: 51/255, alpha: 1))
