...
//    _emoticonPageView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    _emoticonPageView.height       = NIMCustomPageViewHeight;
...
- (void)layoutSubviews{
    ...
    self.emotPageController.y = self.emoticonPageView.nim_bottom - EmotPageControllerMarginBottom;
    self.tabView.nim_bottom = self.height;
}
