...
//    NSLog(@"%@",sender.titleLabel.text);
    ...
    if (index != NSNotFound && self.delegate && [self.delegate respondsToSelector:@selector(popoverView:didSelectItem:)]) {
        [self.delegate popoverView:self didSelectItem:sender.titleLabel.text];
    }
