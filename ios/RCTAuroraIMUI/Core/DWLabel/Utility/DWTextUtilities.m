...
CGAffineTransform DWTextCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform DWTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from DW_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from DW_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from DW_convertPoint:before[2] toViewOrWindow:to];
    
    return DWTextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *DWTextSharedApplication() {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return DWTextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
