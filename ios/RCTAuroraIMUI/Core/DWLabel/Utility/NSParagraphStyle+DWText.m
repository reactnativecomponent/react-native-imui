...
@interface NSParagraphStyle_DWText : NSObject @end
@implementation NSParagraphStyle_DWText @end


@implementation NSParagraphStyle (DWText)

+ (NSParagraphStyle *)DW_styleWithCTStyle:(CTParagraphStyleRef)CTStyle {
...
- (CTParagraphStyleRef)DW_CTStyle CF_RETURNS_RETAINED {
