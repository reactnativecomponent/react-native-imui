...
@class DWTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The DWTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface DWTextAsyncLayer : CALayer
...
/**
 The DWTextAsyncLayer's delegate protocol. The delegate of the DWTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol DWTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by DWTextAsyncLayer to render the contents in background queue.
 */
@interface DWTextAsyncLayerDisplayTask : NSObject
