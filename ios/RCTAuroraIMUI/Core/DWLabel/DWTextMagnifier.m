...
@interface _DWTextMagnifierCaret : DWTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _DWTextMagnifierCaret
...
- (DWTextMagnifierType)type {
    return DWTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(DWTextCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, DWTextCGFloatFromPixel(1));
...
@interface _DWTextMagnifierRanged : DWTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _DWTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding DWTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (DWTextMagnifierType)type {
    return DWTextMagnifierTypeRanged;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, DWTextCGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, DWTextCGFloatPixelFloor(kPadding) + kHeight);
...
@implementation DWTextMagnifier

+ (id)magnifierWithType:(DWTextMagnifierType)type {
    switch (type) {
        case DWTextMagnifierTypeCaret :return [_DWTextMagnifierCaret new];
        case DWTextMagnifierTypeRanged :return [_DWTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[DWTextMagnifier class]]) {
